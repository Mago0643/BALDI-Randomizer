...
public class GameControllerScript : MonoBehaviour
{
	...
	private void Start()
	{
		...
		if (schoolMusic != null)
			schoolMusic.Tempo = UnityEngine.Random.Range(0.5f, 4f);
		if (learnMusic != null)
			learnMusic.Tempo = UnityEngine.Random.Range(0.5f, 4f);
		UpdateItemName();
    }
	...
	private void UpdateNotebookCount()
	{
		if (this.mode == "story")
		{
			this.notebookCount.text = this.notebooks.ToString() + "/" + UnityEngine.Random.Range(7, 100) + " Notebooks";
		}
		else
		{
	...
	public void DeactivateLearningGame(GameObject subject)
	{
		...
		else if (this.notebooks == 7 & this.mode == "story") // Plays the all 7 notebook sound
		{
			...
			endMusic.Tempo = UnityEngine.Random.Range(2f, 4f);
			endMusic.Play();
		}
	}
	...
	{
		this.itemText.text = this.itemNames[UnityEngine.Random.Range(0, itemNames.Length)];
	}
	...
	public void ExitReached()
	{
        ...
        if (this.exitsReached == 1)
		{
			...
			endMusic.Tempo = UnityEngine.Random.Range(0.25f, 1f);
		}
