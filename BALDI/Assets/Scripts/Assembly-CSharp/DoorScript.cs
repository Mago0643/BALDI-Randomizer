...
public class DoorScript : MonoBehaviour
{
	...
	private void Start()
	{
		...
		rnd = FindAnyObjectByType<RndTexture>();
		// doing this will cannot revert the material textures!
		/*closed.mainTexture = rnd.GetRandomTexture();
        open.mainTexture = rnd.GetRandomTexture();*/
		Audio.SetRandomPitch(myAudio);
    }
	...
	public void OpenDoor()
	{
        ...
        // prevents changing texture when clicked door while opened
        if (!bDoorOpen)
        {
            inside.material.mainTexture = rnd.GetRandomTexture();
            outside.material.mainTexture = rnd.GetRandomTexture();
