...
public class MathGameScript : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        gc.learnMusic.DisableChannels(new int[] { 1, 3, 10, 4, 5 });
    ...
    private void Update()
    {
        ...
        if (!this.gc.spoopMode)
        {
            ...
            {
                case 1:
                    if (gc.learnMusic.IsChannelEnabled(4) | gc.learnMusic.IsChannelEnabled(5))
                    {
                        gc.learnMusic.DisableChannels(new int[] { 1, 3, 10, 4, 5 });
                        gc.learnMusic.EnableChannels(new int[] { 1, 3, 10 });
                    }
                    break;
                case 2:
                    if (!gc.learnMusic.IsChannelEnabled(4))
                    {
                        gc.learnMusic.DisableChannels(new int[] { 1, 3, 10, 4, 5 });
                        gc.learnMusic.EnableChannels(new int[] { 1, 3, 10, 4 });
                    }
                    break;
                case 3:
                    if (!gc.learnMusic.IsChannelEnabled(5))
                    {
                        gc.learnMusic.DisableChannels(new int[] { 1, 3, 10, 4, 5 });
                        gc.learnMusic.EnableChannels(new int[] { 1, 3, 10, 4, 5 });
                    }
                    break;
            }
        }
    ...
    {
        Audio.SetRandomPitch(baldiAudio);
        baldiFeed.SetFloat("talkSpeed", UnityEngine.Random.Range(0.5f, 4f));
